      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Center(
              child: Image.asset(
                '/Users/vivian/florida_handbook/assets/airplane.png',
                width: 80,
                height: 80,
              ),
            ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Center(
              child: Image.asset(
                '/Users/vivian/florida_handbook/assets/pensacola.png',
                width: 130,
                height: 130,
              ),
            ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Center(
              child: Image.asset(
                '/Users/vivian/florida_handbook/assets/mco.png',
                width: 150,
                height: 150,
              ),
            ),
      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: Center(
              child: Image.asset(
                '/Users/vivian/florida_handbook/assets/i.png',
                width: 80,
                height: 80,
              ),
            ),
